...
| `deskcal.exe --self-test out.txt` | Chạy 83 test, ghi kết quả ra file |
...
83 test, phủ lịch lặp, điều kiện nhắc, nhắc-trước, parser ngày/giờ, ctor hai form,
layout ô ghi chú, bố cục
cùng cờ cửa sổ của lớp mờ, ngoại lệ chuỗi lặp, và PKCE của OAuth.
