...
| `deskcal.exe --self-test out.txt` | Chạy 106 test, ghi kết quả ra file |
...
106 test, phủ lịch lặp, điều kiện nhắc, nhắc-trước, parser ngày/giờ, ctor hai form,
