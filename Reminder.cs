...
public sealed class Reminder
{
    ...
    public int Scan()
    {
        try
        {
            // Luot quet nay da chay san 60s/lan tren UI thread, nen lop lich tren
            // desktop bam vao day de bat doi ngay / doi do phan giai / doi sang-toi —
            // khong phai hook SystemEvents, hook do ban tren thread khac va keo theo
            // phai dong bo truy cap SQLite.
            Tick?.Invoke();
